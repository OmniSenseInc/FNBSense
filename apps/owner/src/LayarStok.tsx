  ...
  return (
    <div className="min-h-svh bg-stone-50 text-stone-900">
      ...
      <main className="mx-auto max-w-2xl px-4 py-4">
        ...
        {adaNamaHilang && (
          <p className="mb-3 rounded-md border border-sage-300 bg-sage-50 p-3 text-sm text-sage-900">
            ...
            return (
              <li
                ...
                className={`rounded-md border p-3 ${
                  menipis ? 'border-sage-300 bg-sage-50' : 'border-stone-200 bg-white'
                }`}
              >
                <div className="flex items-baseline justify-between gap-3">
                  <p className="text-sm font-semibold">
                    ...
                    {stok.nama ?? (
                      <span className="font-mono text-stone-500">Bahan {stok.id.slice(0, 8)}</span>
                    )}
                  </p>
                ...
                <div className="mt-1 flex items-baseline justify-between gap-3">
                  <p className="text-xs text-stone-500 tabular-nums">{tanggalJam(stok.diperbarui)}</p>
                  {menipis && (
                ...
                {owner && aksi?.id !== stok.id && (
                  <div className="mt-2 flex gap-2">
                    <button
                      ...
                      className="rounded-md border border-stone-300 bg-white px-3 py-1.5 text-xs"
                    >
                      Barang masuk
                    </button>
                    <button
                ...
                {owner && aksi?.id === stok.id && (
                  <form
                    ...
                    className="mt-2 rounded-md border border-stone-300 bg-stone-50 p-2"
                  >
                    ...
                    <div className="mt-1 flex gap-2">
                      <input
                        ...
                        autoFocus
                        className="w-full rounded-md border border-stone-300 px-2 py-1.5 text-sm tabular-nums"
                      />
                      <button
                        type="submit"
                        disabled={sibuk}
                        className="shrink-0 rounded-md bg-stone-900 px-3 py-1.5 text-xs font-semibold text-white disabled:opacity-50"
                      >
                        Simpan
                      </button>
                      <button
                        ...
                        className="shrink-0 rounded-md border border-stone-300 bg-white px-3 py-1.5 text-xs"
                      >
                        Batal
                      </button>
                    </div>

...
/**
 * Deklarasi infra broker BERSAMA (F3a) — exchange event utama + dead-letter.
 * Semua idempoten: aman dipanggil tiap relay start. Nama diambil dari
 ...
 * (mis. realtime.orders) menunjuk ke sana lewat x-dead-letter-exchange.
 */
class EventTopology
{

 ...
 *
 * Ordering tidak menerbitkan token dan tidak punya tabel users. Middleware ini
 * hanya memverifikasi tanda tangan token (RS256) memakai PUBLIC key IAM, lalu
 * mengekspos klaim (tenant_id, outlet_id, role, sub) ke request. Tidak ada query DB / IAM.
 */
class AuthenticateJwt
{
    public function handle(Request $request, Closure $next): Response
    {
        ...
        // outlet_id sengaja BOLEH null: di IAM kolomnya nullable — owner tak wajib
        // terikat outlet (dia mengelola semua outlet tenant-nya), kasir terikat satu.
        // Menolak di sini = mengunci owner keluar. Kewajiban "harus punya outlet"
        // ditegakkan di endpoint kasir, bukan di middleware ini.
